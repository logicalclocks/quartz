...
declare const TinyPopup: ({ title, secondaryText, onClose, mainButtonProps, secondaryButtonProps, tertiaryButtonProps, children, withCloseButton, size, ...props }: TinyPopupProps) => import("react/jsx-runtime").JSX.Element;
